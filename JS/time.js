class Timer {
    ...
    this.getMinutes()
    this.getSeconds()
    this.stringTime = this.computeTwoDigitNumber(this.getMinutes()) + ":"+this.computeTwoDigitNumber(this.getSeconds())
    }
  }
  drawTime(){
    this.CTX.font = "50px College"
    this.CTX.fillStyle ="white"
    this.CTX.fillText(this.stringTime,this.canvasDOM.width/2 - this.CTX.measureText(this.stringTime).width,180)
  }
  getMinutes() {
